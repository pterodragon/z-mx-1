...
#include "MxTelemetryZiCxnTelemetry.h"
#include "QList"
#include "QDebug"

MxTelemetryZiCxnTelemetry::MxTelemetryZiCxnTelemetry()
{
    initTableList();
    initChartList();
    initActiveDataSet();
...
void MxTelemetryZiCxnTelemetry::initActiveDataSet() noexcept
{
...
void MxTelemetryZiCxnTelemetry::initTableList() noexcept
{
...
void MxTelemetryZiCxnTelemetry::getDataForTable(void* const a_mxTelemetryMsg, QLinkedList<QString>& a_result) const noexcept
{

}


void MxTelemetryZiCxnTelemetry::initChartList() noexcept
{
...
double MxTelemetryZiCxnTelemetry::getDataForChart(void* const a_mxTelemetryMsg, const int a_index) const noexcept
{
    // sanity check
    double l_result = 0;
...
QPair<void*, int> MxTelemetryZiCxnTelemetry::getMxTelemetryDataType(void* const a_mxTelemetryMsg, const int a_index) const noexcept
{
