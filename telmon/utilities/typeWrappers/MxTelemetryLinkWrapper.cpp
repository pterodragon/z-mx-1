...
void MxTelemetryLinkWrapper::initChartList() noexcept
{
    ...
    m_chartPriorityToHeapIndex->insert(0, EngineMxTelemetryStructIndex::e_reconnects);

    m_chartList->insert(1, "rxSeqNo");
    m_chartPriorityToHeapIndex->insert(1, EngineMxTelemetryStructIndex::e_rxSeqNo);

    m_chartList->insert(2, "txSeqNo");
    m_chartPriorityToHeapIndex->insert(2, EngineMxTelemetryStructIndex::e_txSeqNo);
...
QPair<void*, int> MxTelemetryLinkWrapper::getMxTelemetryDataType(void* const a_mxTelemetryMsg, const int a_index) const noexcept
{
    ...
    case EngineMxTelemetryStructIndex::e_id:
        ...
        break;
    case EngineMxTelemetryStructIndex::e_rxSeqNo:
        l_result.first = &l_data->rxSeqNo;
        l_result.second = CONVERT_FRON::type_uint64_t;
        break;
    case EngineMxTelemetryStructIndex::e_txSeqNo:
        l_result.first = &l_data->txSeqNo;
        l_result.second = CONVERT_FRON::type_uint64_t;
        break;
    case EngineMxTelemetryStructIndex::e_reconnects:
