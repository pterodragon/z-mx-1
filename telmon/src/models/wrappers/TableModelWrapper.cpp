...
#include "src/models/wrappers/TableModelWrapper.h"
                                         ...
                                         const QString& a_mxTelemetryInstanceName)
{
    ...
    QPair<BasicTableWidget*, TableSubscriber*> l_pair = getTableSubscriberPair(mxTelemetryTypeNameNumber, a_mxTelemetryInstanceName);
    ...
    l_pair.second->setAssociatedObjesctName(a_mxTelemetryInstanceName);
