...
dnl CPPCODEC_LDFLAGS, CPPCODEC_CPPFLAGS
dnl
...
AC_DEFUN([AX_PATH_LIB_CPPCODEC], [
  ...
  if test ".$with_cppcodec" = ".no" ; then
    ...
    if test ".$with_cppcodec" != "." -a ".$with_cppcodec" != ".yes"; then
      ...
      LDFLAGS="-L$with_cppcodec/lib -L$with_cppcodec/lib64 -Wl,-R,$with_cppcodec/lib -Wl,-R,$with_cppcodec/lib64 $LDFLAGS"
    fi
...
int main()
{
  ...
  return strcmp(s.data(), "JBSWY3DPEBLW64TMMQQQ====");
    ...
    if test ".$ax_cv_lib_cppcodec_ok" = ".yes"; then
      ...
      CPPCODEC_CPPFLAGS=""
      if test ".$with_cppcodec" != "." -a ".$with_cppcodec" != ".yes"; then
	AC_MSG_NOTICE([CPPCODEC_LDFLAGS=-L$with_cppcodec/lib -L$with_cppcodec/lib64])
	CPPCODEC_LDFLAGS="-L$with_cppcodec/lib -L$with_cppcodec/lib64 -Wl,-R,$with_cppcodec/lib -Wl,-R,$with_cppcodec/lib64"
